...
export class OllamaClient {
  ...
  async sendToOllama(prompt: string, temperature: number, maxTokens?: number, useFastModel: boolean = false): Promise<string> {
  ...
  async testConnection(testConfig: any): Promise<void> {
    try {
      ...
      this.logger.error('Please ensure Ollama is running on the remote server and both models are available');
    }
  }
